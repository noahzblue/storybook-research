...
```bash
npx storybook-guide-skill
```

Installs the vault to `~/.local/share/storybook-research/` and the skill to `~/.claude/skills/storybook-guide/`. Restart Claude Code after installing.
